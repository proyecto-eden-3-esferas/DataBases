...
-- Edible or otherwise useful crop families:
('Amaryllidaceae', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('Annonaceae',     NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
('Boraginaceae', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('Convolvulaceae',
 NULL,
...
('Fabaceae (Leguminosae)',
 ...
 ('Fagaceae', NULL, 'in temperate regions mostly deciduous, whereas in the tropics, many species occur as evergreen trees and shrubs. They are characterized by alternate simple leaves with pinnate venation. leaves often lobed, and both petioles and stipules generally present.',
 'unisexual flowers in the form of catkins, and fruit in the form of cup-like (cupule) nuts.', 'fruits lack endosperm and lie in a scaly or spiny husk that may or may not enclose the entire nut, which may consist of one to seven seeds', NULL,
 NULL, NULL, NULL),
('Lamiaceae',
 NULL,
...
('Poaceae',
 ...
 -- (family, traits, description, inflorescence_and_flowers, fruits_and_seeds, phytochemistry, photosynthesis, distribution, economics)
 ('Polygonaceae', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
 ('Proteaceae',
  NULL,
  'DESC',
  'FLOWER',
